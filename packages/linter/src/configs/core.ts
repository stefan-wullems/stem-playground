...
const ESLINT_RULES = {
  ...
  'no-unused-vars': ERROR,
   ...
   // Can be turned on again after this is fixed?
  ...
  'no-restricted-imports': [ERROR, {
    paths: [
      /** 
       * These imports are restricted because we decided that we should make very simple functions/components ourselves.
       * This decision was made in anticipation of future bundle size requirements.
       */
      {
        "name": "lodash",
        "importNames": ["capitalize"],
        "message": "Please use capitalize from utils/string instead."
      },
      {
       ...
       /** 
        * These imports are restricted because we have created an enhanced version of these functions/components.
        */
       {
         "name": "@reduxjs/toolkit",
         "importNames": ["createAsyncThunk"],
         "message": [
           "Please use createAsyncThunk from store/utils instead.",
           "This function is populated with some app specific types like RootState and ExtraArguments."
          ].join(' ')
       }
    ]
  }],
...
const TYPESCRIPT_OVERRIDE = {
  ...
  rules: {
    ...
    // This is already checked by Typescript.
    'no-redeclare': OFF,
    // Covered by @typescript-eslint/no-empty-function
